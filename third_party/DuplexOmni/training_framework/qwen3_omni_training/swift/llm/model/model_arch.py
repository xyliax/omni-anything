...
register_model_arch(
    MultiModelKeys(
        MLLMModelArch.qwen3_omni_e2e,
        language_model=['thinker.model', 'thinker.lm_head', 'talker.model', 'talker.code_predictor'],
        vision_tower=['thinker.audio_tower', 'thinker.visual'],
        aligner=[
            'thinker.audio_tower.proj1', 'thinker.audio_tower.proj2', 'thinker.visual.merger',
            'thinker.visual.merger_list', 'talker.hidden_projection', 'talker.text_projection'
        ],
        generator=['talker', 'code2wav'],
    ))
