...
| Background / Problem | Canonical terminology and problem owner | Workload abstraction, resource conflict, constraints, design goals | System solution details, result conclusions, unfrozen evaluation scope | A reader can derive the challenges without seeing the implementation |
...
| Evaluation Methodology | Main claim, module hypotheses, evidence rules | Reviewer questions, controls, metrics, sweep, statistics, failure gates | Results, post-hoc thresholds, unfrozen platform or modality decisions | Each claim has a falsifying experiment and matched control |
