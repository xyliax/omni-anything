...
\title{Pilarius: Multiplexing GPU Memory through Cyclic KV Restoration for Interactive Model Serving}
...
\keywords{KV cache, GPU memory management, model serving, full-duplex interaction, real-time inference, memory multiplexing, scheduling}
