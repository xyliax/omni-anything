...
| 主张 | 来源 |
|---|---|
| E 系列真机结论（现行） | `FINDINGS.md`、`results/e1_capacity_bottleneck/` |
| H2D / DMA 标定 | `experiments/e0_dma_interference/reference_data/pcie_h2d_bench.json`；E0 证据 `results/e0_dma_interference/` |
