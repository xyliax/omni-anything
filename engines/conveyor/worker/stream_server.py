...
ORIGIN: copied from engines/baseline/worker/stream_server.py and permanently diverged.
...
infra/trace/parse.py): PERREQ_LOG gets P/F/T/SEED plus the five ingest stations
