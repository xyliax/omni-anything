...
mechanism modules that live next to it, then chain-loads the tracekit
...
failure exits 78 (EX_CONFIG, matching the tracekit collector's convention).
...
# tracekit / engine patch, see tests/test_run_validation.py) keeps one
