...
chain-loads the tracekit scheduler-trace collector when tracing/residency
...
if os.environ.get("OMNI_SESSION_MAXTOKENS_FIX"):
    try:
        ...
        # EX_CONFIG, matching the tracekit collector's convention.
        os._exit(78)
...
if os.environ.get("OMNI_SCHEDULER_TRACE") or os.environ.get("OMNI_RESIDENCY_LOG"):
    try:
        ...
        _root = os.path.dirname(  # engine_fix -> worker -> baseline -> experiments -> repo
